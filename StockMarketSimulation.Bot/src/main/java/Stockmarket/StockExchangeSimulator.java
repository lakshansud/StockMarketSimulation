...
import Stockmarket.service.impl.TradeService;
...
public class StockExchangeSimulator {
	...
	static String[] setOfSymbols = new String[] { "HP", "DELL", "MAC", "ACER", "MICROSOFT" };
	
	static int[] percentageDiff = new int[] {  -3, -2, -1, 0, 1, 2, 3,  };
	...
	public static void main(String[] args) throws InvalidStockException {
		...
		stock1.setSymbol("MICROSOFT");
		stock1.setParValue(100);
		stock1.setCurrency(Currency.LKR);
		...
		int simulationTimeInMinutes = 2100;
